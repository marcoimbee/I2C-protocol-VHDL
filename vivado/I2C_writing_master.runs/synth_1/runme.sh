...
HD_PWD='C:/Users/Marco/Desktop/project/vhdl/vivado/I2C_writing_master.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log I2C_writing_master.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source I2C_writing_master.tcl
