...
HD_PWD='C:/Users/Marco/Desktop/project/vhdl/vivado/I2C_writing_master.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log I2C_writing_master.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source I2C_writing_master.tcl -notrace
